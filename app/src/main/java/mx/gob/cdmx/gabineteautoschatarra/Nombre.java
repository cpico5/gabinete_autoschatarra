...
public class Nombre  {
    ...
    public static final String encuesta = "gabinete_autoschatarra";
//    public static final String USUARIO = "usuario";
    ...
    public String nombreEncuesta(){
        ...
        final String nombreEncuesta = "gabinete_autoschatarra";
        return nombreEncuesta;
    }

    public String nombreDatos(){

        final String nombreEncuesta = "datos_gabinete_autoschatarra";
        return nombreEncuesta;
    }
